...
//
// This demo will set the high bits to 1, effectively creating fully opaque
// tiles that use 2bpp palette colours 2 & 3.
//
//
...
define REGION = Japan
define ROM_NAME = "VMAIN 1BPP TILES 1"
define VERSION = 1
...
// with a high bit of 1.
//
// The tiles will be fully opaque and will use 2bpp palette colours 2 & 3.
//
...
i16()
code()
function Transfer1bppTilesToVram_1 {
    ...
    // Second DMA transfer.
    //
    // Fill the high bits with ones (0xff)
    ...
    ldx.w   #Resources.FixedByteFF
    stx.w   A1T0
    lda.b   #Resources.FixedByteFF >> 16
    sta.w   A1B0
