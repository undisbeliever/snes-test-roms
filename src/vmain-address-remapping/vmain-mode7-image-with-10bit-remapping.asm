// A demonstration of a Mode 7 tile buffer with 10bit VMAIN remapping.
//
...
define ROM_NAME = "VMAIN MODE7 REMAP 10"
...
function TransferTileBufferToVram {
    ...
    lda.b   #VMAIN.remap._10bits | VMAIN.increment.by128 | VMAIN.incrementMode.high
    sta.w   VMAIN
