// Clear joypad latch during auto-joypad read test
//
...
define ROM_NAME = "JOYSER0 WR AUTOJOY 0"

define TEST_NAME = "Clear joypad latch (1 -> 0)\nduring AUTOJOY test"
define VERSION = 3
...
constant JOYSER_LATCH_START_VALUE = 1
